...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            <td class="info-value" colspan="2" rowspan="2">{{ $employee->inscription }}</td>
            <td class="info-value" colspan="4" rowspan="2">{{ $employee->name }}</td>
            <td class="info-value" colspan="3">{{ $period }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"></td>
            <td class="info-value" colspan="3" rowspan="2">{{ $employee->position }}</td>
        </tr>
    </table>
